...
jquery_lang_js.prototype.convert = function (text, lang) {
  if (lang) {
    if (this.lang[lang]) {
        if (this.lang[lang][text]) { return this.lang[lang][text]; }
        else { return text; }
    }
    else { return this.lang[this.currentLang][text]; }

  } else {
    if (this.lang[this.currentLang][text]) { return this.lang[this.currentLang][text]; }
    else { return text; }
  }
};
